...
Pod::Spec.new do |s|
  ...
  s.name         = "RecordButtonSwift"
  s.version      = "0.0.2"
  s.summary      = "Animated and Progressive Record Button"
  ...
  s.homepage     = "https://github.com/svtek/RecordButton"
  ...
  s.source       = { :git => "https://github.com/svtek/RecordButton.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "RecordButton/Classes/**/*"
  ...
  # s.resource  = "icon.png"
  s.resources = "RecordButton/Assets/**/*"
